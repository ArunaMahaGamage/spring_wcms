...
public class ComplainController {
    ...
    public @ResponseBody Complain createComplain(Complain complain) {
        return complainService.createComplain(complain);
    }

    @PostMapping(path="/read-complain")
    public @ResponseBody Complain readComplain(Complain complain) {
        return complainService.readComplain(complain);
    }

    @PostMapping(path="/update-complain")
    public @ResponseBody Complain updateComplain(Complain complain) {
        return complainService.updateComplain(complain);
    }

    @PostMapping(path="/delete-complain")
    public @ResponseBody Complain deleteComplain(Complain complain) {
